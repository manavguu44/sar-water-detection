...
best_val_iou = -1
TEMPORAL_MODEL_PATH = OUTPUT_DIR / "temporal_unet_model.pth"
for epoch in range(EPOCHS):
    ...
    if val_iou > best_val_iou:
        ...
        torch.save(model.state_dict(), TEMPORAL_MODEL_PATH)
        print("Saved best Temporal UNet model.")
...
plt.tight_layout()
plt.savefig(OUTPUT_DIR / "temporal_unet_sample_result.png", dpi=150)
plt.show()