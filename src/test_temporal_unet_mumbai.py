...
sar_path = DATA_DIR / "mumbai_temporal_vv_vh.tif"
...
with rasterio.open(OUTPUT_DIR / "mumbai_temporal_unet_prediction.tif", "w", **profile) as dst:
...
plt.tight_layout()
plt.savefig(OUTPUT_DIR / "temporal_unet_result.png", dpi=160)
plt.close()
